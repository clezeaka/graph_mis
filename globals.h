...
class Vertex
{
 public:
  ...
  volatile unsigned long finalColor;
  ...
  inline void color_vertex(Vertex *_vertices, unsigned char *_tournamentArray, unsigned int *_neighbors, unsigned long _bitColor);
